...
HD_PWD='R:/Users/Mitchell/Documents/Microarchitecture/NEORV32/NEORV32.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log neorv32_test_setup.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source neorv32_test_setup.tcl -notrace
