...
#
# Generated by Vivado on Fri Apr 16 13:04:56 -0700 2021
# SW Build 3064766 on Wed Nov 18 09:12:45 MST 2020
#
# Copyright 1986-2020 Xilinx, Inc. All Rights Reserved. 
#
# usage: potato_design.sh [-help]
# usage: potato_design.sh [-lib_map_path]
# usage: potato_design.sh [-noclean_files]
# usage: potato_design.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "potato_design.sh - Script generated by export_simulation (Vivado v2020.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L work -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot potato_design work.potato_design work.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim potato_design -key {Behavioral:sim_1:Functional:potato_design} -tclbatch cmd.tcl -protoinst "protoinst_files/potato_design.protoinst" -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./potato_design.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb potato_design.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./potato_design.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: potato_design.sh [-help]\n\
Usage: potato_design.sh [-lib_map_path]\n\
Usage: potato_design.sh [-reset_run]\n\
Usage: potato_design.sh [-noclean_files]\n\n\
