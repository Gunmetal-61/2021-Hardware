...
#
# Generated by export_simulation on Fri Apr 16 13:04:56 -0700 2021
#
################################################################################
...
'-reset_run' switch to the './potato_design.sh' script.

./potato_design.sh -reset_run
...
./potato_design.sh -noclean_files

For more information on the script, please type './potato_design.sh -help'.
