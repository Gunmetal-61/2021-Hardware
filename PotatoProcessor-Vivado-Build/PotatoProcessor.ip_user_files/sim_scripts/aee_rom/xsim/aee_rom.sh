...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L work -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot aee_rom work.aee_rom work.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim aee_rom -key {Behavioral:sim_1:Functional:aee_rom} -tclbatch cmd.tcl -protoinst "protoinst_files/potato_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb aee_rom.wdb xsim.dir)
