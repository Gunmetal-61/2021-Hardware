...
#
# Generated by export_simulation on Thu Apr 22 16:44:23 -0700 2021
#
################################################################################
...
'-reset_run' switch to the './aee_rom.sh' script.

./aee_rom.sh -reset_run
...
./aee_rom.sh -noclean_files

For more information on the script, please type './aee_rom.sh -help'.
