...
HD_PWD='R:/Users/Mitchell/Documents/Academics/PotatoProcessor/PotatoProcessor.runs/clock_generator_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_generator.tcl
