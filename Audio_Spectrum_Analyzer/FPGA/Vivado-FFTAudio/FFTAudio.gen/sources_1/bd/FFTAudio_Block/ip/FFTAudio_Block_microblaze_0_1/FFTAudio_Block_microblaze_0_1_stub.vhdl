...
-- Date        : Wed Jun  9 13:11:53 2021
-- Host        : HORIZON running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top FFTAudio_Block_microblaze_0_1 -prefix
--               FFTAudio_Block_microblaze_0_1_ FFTAudio_Block_microblaze_0_1_stub.vhdl
-- Design      : FFTAudio_Block_microblaze_0_1
...
entity FFTAudio_Block_microblaze_0_1 is
  Port ( 
    Clk : in STD_LOGIC;
    Reset : in STD_LOGIC;
...
end FFTAudio_Block_microblaze_0_1;

architecture stub of FFTAudio_Block_microblaze_0_1 is
...
attribute x_core_info of stub : architecture is "MicroBlaze,Vivado 2020.2.2";
begin
end;
