...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.FFTAudio_Block \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../FFTAudio.gen/sources_1/bd/FFTAudio_Block/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../FFTAudio.gen/sources_1/bd/FFTAudio_Block/ipshared/d0f7" \
       +incdir+"../../../../FFTAudio.gen/sources_1/bd/FFTAudio_Block/ipshared/ec67/hdl" \
       +incdir+"../../../../FFTAudio.gen/sources_1/bd/FFTAudio_Block/ipshared/d0f7"
}
